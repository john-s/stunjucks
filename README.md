...
Another use case is quick migration of high-traffic urls off of Python frameworks that use similar templating engines, such as the Jinja2 and Django template engines.  Making high-traffic, non-dynamic pages (e.g. root hero page, landing pages, FAQs, about us pages) totally static often solves many scalability issues. Since Nunjucks is very similar to Jinja2 and therefore the Django templating framework, migrating the templates is easy.
